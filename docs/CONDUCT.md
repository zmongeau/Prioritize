...
* Distracted technology use (such as cell phones) during all team meetings
...
* Decisions will be made with a consensus vote

## Attendance

* Frequent attendance is expected
* Legitimate reasons for missing include any emergencies, illness, etc
* Missing members will have to make up their tasks

## Assignments

* Assignments will be handed out through the GitHub Project Board for the app
* Group members who miss or do not complete repeated assignments will be brought up to the professor
...
* Notes will be stored in the GitHub Repo

## Promptness

* Tasks are expected to be completed on time/on track with set due dates
* Lateness will be handled by checking in with group members and ensuring everything is on track
