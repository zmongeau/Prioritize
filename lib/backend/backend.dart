...
import 'schema/task_data_record.dart';
...
export 'schema/task_data_record.dart';
...
/// Functions to query TaskDataRecords (as a Stream and as a Future).
Future<int> queryTaskDataRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TaskDataRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TaskDataRecord>> queryTaskDataRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TaskDataRecord.collection,
      TaskDataRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TaskDataRecord>> queryTaskDataRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
