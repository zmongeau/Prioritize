...
import 'task_list_copy_model.dart';
export 'task_list_copy_model.dart';
...
/// both.
class TaskListCopyWidget extends StatefulWidget {
  const TaskListCopyWidget({super.key});

  static String routeName = 'TaskListCopy';
  static String routePath = '/TaskListCopy';

  @override
  State<TaskListCopyWidget> createState() => _TaskListCopyWidgetState();
}

class _TaskListCopyWidgetState extends State<TaskListCopyWidget> {
  late TaskListCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskListCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'TaskListCopy'});
