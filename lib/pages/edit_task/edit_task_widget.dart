            ...
            child: Form(
              ...
              child: StreamBuilder<List<TaskDataRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<TaskDataRecord> columnTaskDataRecordList =
                      snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final columnTaskDataRecord =
                      columnTaskDataRecordList.isNotEmpty
                          ? columnTaskDataRecordList.first
                          : null;
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'EDIT_TASK_PAGE_arrow_back_ICN_ON_TAP');
                                      logFirebaseEvent(
                                          'IconButton_navigate_to');

                                      context
                                          .pushNamed(TaskListWidget.routeName);
                                    },
                                  ),
                                ],
                              ),
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'EDIT_TASK_PAGE_Container_qow0nauz_ON_TAP');
                                  logFirebaseEvent(
                              ...
                              child: Padding(
                                ...
                                child: StreamBuilder<List<TaskDataRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<TaskDataRecord>
                                        buttonTaskDataRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the item does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final buttonTaskDataRecord =
                                        buttonTaskDataRecordList.isNotEmpty
                                            ? buttonTaskDataRecordList.first
                                            : null;

                                    return FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDIT_TASK_PAGE_UPDATE_TASK_BTN_ON_TAP');
